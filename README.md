...
4.  **Testandmed:** Genereerida `ee-test` X-teel olevale andmejälgija teenusele testkirjed kokkulepitud demo-isikukoodile (näiteks `60001017869`), et RIA saaks veenduda teenuse toimimises.
